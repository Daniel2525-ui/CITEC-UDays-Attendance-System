...
export default function ReportTable({ rows, loading }) {
  return (
    <div className="rounded-3xl bg-white p-6 shadow-xl shadow-blue-900/5 ring-1 ring-gray-100 sm:p-8">
      <div className="max-h-150 overflow-y-auto overflow-x-auto rounded-2xl ring-1 ring-gray-100">
        <table className="w-full text-left text-sm">
          <thead className="sticky top-0 z-10 bg-gray-50 text-xs font-semibold uppercase tracking-wide text-gray-400">
            <tr>
